...
{
    #region PicoIocException Tests

    [Fact]
    public void PicoIocException_DefaultConstructor()
    {
        // Act
        var ex = new PicoIocException();
    ...
    [Fact]
    public void PicoIocException_MessageConstructor()
    {
        // Act
        var ex = new PicoIocException("Test message");
    ...
    [Fact]
    public void PicoIocException_MessageAndInnerExceptionConstructor()
    {
        // Arrange
        var innerEx = new InvalidOperationException("Inner");

        // Act
        var ex = new PicoIocException("Outer", innerEx);
    ...
    [Fact]
    public void GetService_UnregisteredType_ThrowsPicoIocException()
    {
        // Arrange
        ...
        var ex = Assert.Throws<PicoIocException>(() => scope.GetService<IGreeter>());
        Assert.Contains("IGreeter", ex.Message);
        Assert.Contains("not registered", ex.Message);
    }

    [Fact]
    public void GetServices_UnregisteredType_ThrowsPicoIocException()
    {
        // Arrange
        var container = new SvcContainer();
        ...
        // Act & Assert
        using var scope = container.CreateScope();
        var ex = Assert.Throws<PicoIocException>(() => scope.GetServices<IGreeter>().ToList());
        Assert.Contains("IGreeter", ex.Message);
        Assert.Contains("not registered", ex.Message);
    }

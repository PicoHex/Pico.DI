...
.NET 10.0.1, Native AOT compiled, 1M iterations
...
║ Method                        ║     Mean     ║              Notes            ║
╠═══════════════════════════════╬══════════════╬═══════════════════════════════╣
║ Pico.DI - Container Setup     ║    ~650 ns   ║ Zero-reflection factories     ║
║ MS.DI - Container Setup       ║  ~1,570 ns   ║ Expression compilation        ║
╚═══════════════════════════════╩══════════════╩═══════════════════════════════╝
                    ↑ Pico.DI is 2.4x faster at container setup! ↑

╔══════════════════════════════════════════════════════════════════════════════╗
║                  SERVICE RESOLUTION (ns, lower = better)                     ║
╠═══════════════════════════════╦══════════════╦═══════════════════════════════╣
║ Method                        ║     Mean     ║  Winner (in AOT mode)         ║
╠═══════════════════════════════╬══════════════╬═══════════════════════════════╣
║ Pico.DI - Singleton           ║     ~62 ns   ║                               ║
║ MS.DI - Singleton             ║     ~35 ns   ║ ← MS.DI ~1.8x faster          ║
╠═══════════════════════════════╬══════════════╬═══════════════════════════════╣
║ Pico.DI - Transient           ║     ~68 ns   ║  Nearly equal                 ║
║ MS.DI - Transient             ║     ~62 ns   ║ ← MS.DI ~1.1x faster          ║
╠═══════════════════════════════╬══════════════╬═══════════════════════════════╣
║ Pico.DI - Scoped              ║     ~92 ns   ║                               ║
║ MS.DI - Scoped                ║     ~83 ns   ║ ← MS.DI ~1.1x faster          ║
╠═══════════════════════════════╬══════════════╬═══════════════════════════════╣
║ Pico.DI - Complex (3 deps)    ║    ~328 ns   ║                               ║
║ MS.DI - Complex (3 deps)      ║    ~193 ns   ║ ← MS.DI ~1.7x faster          ║
╚═══════════════════════════════╩══════════════╩═══════════════════════════════╝
```

**📊 Analysis:**
- **Container Setup:** Pico.DI is **2.4x faster** — ideal for serverless/microservices cold start
- **Service Resolution:** MS.DI slightly faster in AOT mode (both use pre-compiled delegates)
- **Key Advantage:** Pico.DI provides **true zero-reflection** design, **compile-time validation**, and **smaller binary footprint**

...
public class ServiceRegistrationGenerator : IIncrementalGenerator
{
    ...
    private static string GenerateSource(List<ServiceRegistration> registrations)
    {
        ...
        sb.AppendLine("    /// </summary>");
        sb.AppendLine(
            "    public static global::Pico.IoC.Abs.ISvcContainer ConfigureGeneratedServices(this global::Pico.IoC.Abs.ISvcContainer container)"
        );
        sb.AppendLine("    {");
        ...
        foreach (var reg in registrations)
        {
            ...
            if (reg.ConstructorParameters.IsEmpty)
            {
                ...
                sb.AppendLine(
                    $"        container.Register(new global::Pico.IoC.Abs.SvcDescriptor("
                );
